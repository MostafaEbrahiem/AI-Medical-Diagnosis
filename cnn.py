...
def start():
    TRAIN_DIR1 = 'train/Acne'
    TRAIN_DIR2 = 'train/Hairloss'
    TRAIN_DIR3 = 'train/Nail Fungus'
    TRAIN_DIR4 = 'train/Normal'
    TRAIN_DIR5 = 'train/Skin Allergy'
    TRAIN_DIR6 = 'train/benign'
    TRAIN_DIR7 = 'train/malignant'
    TRAIN_DIR = []
...
def built_model(X_train, y_train, IMG_SIZE, MODEL_NAME, LR):
    ...
    if (os.path.exists('model.tfl.meta')):
        ...
        model.fit({'input': X_train1}, {'targets': y_train1}, n_epoch=18,
